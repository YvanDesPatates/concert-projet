...
class ConcertHallController extends AbstractController
{
    ...
    #[Route('/new/admin', name: 'app_concert_hall_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}/edit/admin', name: 'app_concert_hall_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}/admin', name: 'app_concert_hall_delete', methods: ['POST'])]
